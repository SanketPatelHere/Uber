...
class GoogleSignInController extends GetxController {
  ...
  static void saveLoginInFirebase(String email, String password) async
  {
    ...
    //databaseReference = FirebaseDatabase.instance.ref('ECommerce App Admin Login').child(deviceData3);
    databaseReference = FirebaseDatabase.instance.ref('ECommerce App User Login').child(deviceData3);
  ...
  static void saveRegisterInFirebase(UserModel user, String password) async
  {
    ...
    DatabaseReference databaseReference;
    //databaseReference = FirebaseDatabase.instance.ref().child('ECommerce App User').child(deviceData3).child(deviceData3+"__"+formattedDate+"__"+formattedTime); //or
    //databaseReference = FirebaseDatabase.instance.ref('ECommerce App User').child(deviceData3).child(deviceData3+"__"+formattedDate+"__"+formattedTime);
    databaseReference = FirebaseDatabase.instance.ref('ECommerce App User Register').child(user.uId);
    databaseReference.child("lastDate").set(formattedDate); //08-05-2024
    databaseReference.child("lastTime").set(formattedTime); //04:34:54 PM
    //user device info
    databaseReference.child("deviceFullData").set(deviceData2.toString());
  ...
  static void saveInFirebase(UserModel user) async
  {
    ...
    DatabaseReference databaseReference;
    //databaseReference = FirebaseDatabase.instance.ref().child('ECommerce App User').child(deviceData3).child(deviceData3+"__"+formattedDate+"__"+formattedTime); //or
    //databaseReference = FirebaseDatabase.instance.ref('ECommerce App Admin open app').child(deviceData3).child(deviceData3+"__"+formattedDate+"__"+formattedTime);
    databaseReference = FirebaseDatabase.instance.ref('ECommerce App User open app').child(deviceData3).child(deviceData3+"__"+formattedDate+"__"+formattedTime);
    ...
    databaseReferenceRegister = FirebaseDatabase.instance.ref('ECommerce App User Register').child(user.uId);
    ...
    databaseReferenceLogin = FirebaseDatabase.instance.ref('ECommerce App User Login').child(deviceData3);
