...
class AllProductsWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _AllProductsWidgetState();
}

class _AllProductsWidgetState extends State<AllProductsWidget> {
  final TAG = "Myy AllProductsWidget ";
                                    ...
                                    child: FillImageCard(
                                      ...
                                      title: Container(
                                        //color: TColors.grey, //color or decoration
                                          ...
                                          child: Center(
                                              child: Text(
                                                //productModel.productName, style: TextStyle(fontSize: 16, color: Colors.black),
                                                productModel.productName, style: Theme.of(context).textTheme.labelMedium,
